...
import { IconComponent } from "@/icons/skills";
...
const SkillIcon = ({ skill }: { skill: SkillI }) => {
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        <IconComponent iconName={skill.icon} className="w-6 h-6 text-slate-600 hover:text-slate-800 transition-colors cursor-pointer" />
      </div>
